...
export class AuthController {
  ...
  @Public()
  @Post('test')
  async test(@Body() body: SignupBodyDto): Promise<any> {
    return body;
  }

  @Public()
  @Post('signup')
  async signup(@Body() body: SignupBodyDto): Promise<ResTokens> {
  ...
  @Public()
  @Post('signin')
  async signin(@Body() body: SigninBodyDto): Promise<ResTokens> {
